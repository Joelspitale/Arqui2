...
miMain: // X0 pixels	
	...
	loop2:	
		...
		no_disparo:	        	//me muevo hacia la izquierda
		...
		ver_der:			//me muevo hacia la derecha
		...
		mov	x4,#2		//fila 2 de mi imagen es la que hago para que cierre y abra los ojos mientras no hace nada
		wait: 	// wait for frame
   	        ldrb	w7, [x15, #8]
		subs	wzr, w7, #1
                b.ne	wait
	...
	pintar_pantalla_color:
		...
		//		x4->inicio de ancho, x5->contador de cuadro de mi imagen
	...
	draw_image:
		...
		mov 	x21,#192		//se que tengo 1152000 pixels en una fila de pixeles de mi imagen
	 ...
	 draw_image_loop:
		...
		dibujar_bala:
		sub     sp, sp ,48		//se que tengo 1152000 pixels en una fila de 10 imagenes
		str     x29,[sp, 40]		// x5=contador_colum,x4=contador_fila 
		str     x30,[sp, 32]		//no pasarme de izq a derecha
		str     x4,[sp, 24]
		str     x5,[sp, 16]
		str     x6,[sp, 8]
		str     x7,[sp, 0]
